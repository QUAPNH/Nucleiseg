...
class Anchors(object):
    def __init__(self, img_height, img_width):
        ...
        min_scale = np.array([0.01, 0.02, 0.04, 0.1 , 0.26, 0.42])
        max_scale = np.array([0.02, 0.04, 0.1 , 0.26, 0.42, 0.58])
        self.img_size = np.array([img_height, img_width])  #array([512, 640])
        self.pyramid_levels = [1,2,3, 4, 5, 6]
        ...
        self.aspect_ratios = [[2],[2,3],[2,3], [2, 3], [2, 3], [2, 3]]
